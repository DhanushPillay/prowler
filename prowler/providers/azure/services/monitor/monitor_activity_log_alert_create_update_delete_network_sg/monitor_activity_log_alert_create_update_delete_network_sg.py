...
class monitor_activity_log_alert_create_update_delete_network_sg(Check):
    def execute(self) -> Check_Report_Azure:
        ...
        for subscription, alert_rules in monitor_client.alert_rules.items():
            ...
            report.status_extended = f"There is not an active log alert for 'Create, Update or Delete Network Security Group' in subscription {subscription}."
                                ...
                                if (
                                    ...
                                    for condition in alert_rule.condition.all_of:
                                        if (
                                            ...
                                            report.status = "PASS"
                                            report.status_extended = f"There is an active log alert for 'Create, Update or Delete Network Security Group' in subscription {subscription}."
